                            ...
                            <!-- <div class="item"> -->
                                <div class="cardclient-blocks dark-primary-border">
                                  <div class="card-header" role="tab" id="heading-{{$i}}">
                                      <span data-parent="#accordion" data-toggle="collapse" aria-expanded="false" aria-controls="collapse{{$i}}">
                                        <h5 class="mb-0"><a href="{{ $item->get_permalink() }}">{{ $item->get_title() }}</a></h5>
                                      </span>
                                  </div>
